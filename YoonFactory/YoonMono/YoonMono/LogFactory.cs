...
{
    /*  Log 기록시 사용하는 Enum */
    public class LogMonoArgs : LogArgs
    {
        public Gdk.Color BackColor;

        public LogMonoArgs(Gdk.Color pColor, string strMessage)
        {
            Message = strMessage;
            BackColor = pColor;
        }
            ...
            lock (m_logLock)
            {
                ...
                switch (index)
                {
                    ...
                    case eYoonStatus.Normal:
                        ...
                        OnProcessLogEvent(this, new LogMonoArgs(ColorFactory.White, strMessageLine));
                        break;
                    ////  기타 확인 : 오류 메세지 설명은 별도로 저장
                    case eYoonStatus.Conform:
                        strMessageLine = "[" + nowTime + "]  CONFIRM : " + strMessage + "\n";
                        OnProcessLogEvent(this, new LogMonoArgs(ColorFactory.Khaki, strMessageLine));
                        break;
                    ////  전송 확인 : 전송 메시지 출력
                    case eYoonStatus.Send:
                        strMessageLine = "[" + nowTime + "]  SEND : " + strMessage + "\n";
                        OnProcessLogEvent(this, new LogMonoArgs(ColorFactory.Lavender, strMessageLine));
                        break;
                    ////  수신 확인 : 수신 메시지 출력
                    ...
                    case eYoonStatus.User:
                        ...
                        OnProcessLogEvent(this, new LogMonoArgs(ColorFactory.Lime, strMessageLine));
                        break;
                    ...
                    case eYoonStatus.Error:
                        ...
                        OnProcessLogEvent(this, new LogMonoArgs(ColorFactory.Salmon, strMessageLine));
                        break;
