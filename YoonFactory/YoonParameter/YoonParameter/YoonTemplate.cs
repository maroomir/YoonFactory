...
namespace YoonFactory.Param
{
    ...
    public class YoonTemplate<TKey, TValue> : IYoonTemplate, IYoonSection<TKey, TValue> where TKey : IConvertible where TValue : IYoonTemplate
    {
        ...
        public void CopyFrom(IYoonTemplate pTemplate)
        {
            if (pTemplate is YoonTemplate<TKey, TValue> pTemplateOrigin)
            {
                Clear();
