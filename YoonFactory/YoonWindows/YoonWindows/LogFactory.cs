...
namespace YoonFactory.Windows.Log
{
    ...
    public class LogArgs : EventArgs
    {
        ...
        public LogArgs(Color pColor, string strMessage, bool bStackClear)
        {
            BackColor = pColor;
            Message = strMessage;
            ...
            lock (m_logLock)
            {
                ...
                switch (index)
                {
                    ...
                    case eYoonStatus.Normal:
                        ...
                        OnLogDisplayEvent(this, new LogArgs(ColorTranslator.FromHtml("Khaki"), strMessage, bRequestClear));
                        break;
                    ...
                    case eYoonStatus.Send:
                        ...
                        OnLogDisplayEvent(this, new LogArgs(ColorTranslator.FromHtml("Lavender"), strMessage, bRequestClear));
                        break;
                    ////  수신 확인 : 수신 메시지 출력
                    ...
                    case eYoonStatus.User:
                        ...
                        OnLogDisplayEvent(this, new LogArgs(ColorTranslator.FromHtml("Lime"), strMessage, bRequestClear));
                        break;
                    ...
                    case eYoonStatus.Error:
                        ...
                        OnLogDisplayEvent(this, new LogArgs(ColorTranslator.FromHtml("Salmon"), strMessage, bRequestClear));
                        break;
