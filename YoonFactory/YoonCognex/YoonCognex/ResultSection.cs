...
{
    public class ResultSection : IYoonContainer, IYoonContainer<string, CognexResult>
    {
        ...
        {
            if (pContainer is ResultSection pSection)
            {
                Clear();
        ...
        {
            return new ResultSection(this, Comparer);
        }
